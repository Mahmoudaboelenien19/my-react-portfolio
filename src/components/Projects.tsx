...
const Projects = () => {
  ...
  const Y_BigFigure = useTransform(scrollYProgress, [0.25, 0.4], [600, 0]);
  ...
  const X_smallFigure1 = useTransform(scrollYProgress, [0.55, 0.8], [-600, 0]);
  const X_smallFigure2 = useTransform(scrollYProgress, [0.55, 0.8], [600, 0]);
